...
INSERT INTO LECCIONES VALUES(1,1,'Variables');
INSERT INTO LECCIONES VALUES(2,1,'Operadores Aritmeticos');
INSERT INTO LECCIONES VALUES(3,1,'Repaso');
INSERT INTO LECCIONES VALUES(4,1,'Operadores Logicos');
INSERT INTO LECCIONES VALUES(5,1,'Bucles');
INSERT INTO LECCIONES VALUES(6,1,'Examen');

INSERT INTO LECCIONES VALUES(7,2,'Creacion tablas');
INSERT INTO LECCIONES VALUES(8,2,'Constraints');
INSERT INTO LECCIONES VALUES(9,2,'Repaso');
INSERT INTO LECCIONES VALUES(10,2,'Alter table/Insert into');
INSERT INTO LECCIONES VALUES(11,2,'Update/Delete');
INSERT INTO LECCIONES VALUES(12,2,'Examen');

INSERT INTO LECCIONES VALUES(13,3,'Estructura basica');
INSERT INTO LECCIONES VALUES(14,3,'Listas');
INSERT INTO LECCIONES VALUES(15,3,'Repaso');
INSERT INTO LECCIONES VALUES(16,3,'Enlaces');
INSERT INTO LECCIONES VALUES(17,3,'Formularios');
INSERT INTO LECCIONES VALUES(18,3,'Examen');

INSERT INTO LECCIONES VALUES(19,4,'Inicio CSS');
INSERT INTO LECCIONES VALUES(20,4,'Estructura CSS');
INSERT INTO LECCIONES VALUES(21,4,'Repaso');
INSERT INTO LECCIONES VALUES(22,4,'Colores');
INSERT INTO LECCIONES VALUES(23,4,'Medidas Posicionamiento');
INSERT INTO LECCIONES VALUES(24,4,'Examen');

CREATE TABLE USUARIOS_LECCIONES(
    ID_LECCION NUMBER(2) CONSTRAINT FK_USERLEC_IDLEC REFERENCES LECCIONES(ID_LECCION),
    ID_USUARIO NUMBER(2) CONSTRAINT FK_USERLEC_IDUSER REFERENCES USUARIOS(ID_USUARIO),
    COMPLETADA BOOLEAN,
    CONSTRAINT PK_USERLEC_IDLECIDUSER PRIMARY KEY (ID_LECCION, ID_USUARIO)
);
...
INSERT INTO NOTIFICACIONES VALUES(1, '¡ENHORABUENA, Has completado un nivel!');
INSERT INTO NOTIFICACIONES VALUES(2, 'No te olvides de hacer alguna lección hoy');
INSERT INTO NOTIFICACIONES VALUES(3, '¡Que icono más chulo, prueba a ponertelo!');
INSERT INTO NOTIFICACIONES VALUES(4, '¡Trata de ser el mejor en el ranking!');


drop table USUARIOS_NOTIFICACIONES;

CREATE TABLE USUARIOS_NOTIFICACIONES(
    ID_NOTIFICACION NUMBER(2) CONSTRAINT FK_USUNOTIF_IDNOTIF REFERENCES NOTIFICACIONES(ID_NOTIFICACION),
